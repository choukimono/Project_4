...
\chapter{Implementation}
    ...
    \paragraph{}For the programs of this project, we will use a object-oriented programing instead of standard programing with a lot of functions and variables. The program will then be closer to how we conceptualize the model.

    \section{Calculations of the physical properties of a system}
            ...
            \SetAlgoLined
                ...
                $\textbf{init}$ $\textnormal{acc\_conf}$ the number of accepted configuration\\
                    \For{$n \leq mc$}
                    {
                        ...
                        $\textbf{choose}$ the corresponding $\Delta E$ \Comment{voir Table 1.2}\\                
