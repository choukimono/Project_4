...
\chapter{Theory}
    ...
    \section{The Ising model}
        ...
        \subsection{Two-dimensional square lattice model}
            ...
            Similarly, we compute the mean value of the magnetic moment (or mean magnetization) $\langle M \rangle$ :
            
                \begin{equation*}
                    \langle M \rangle = \sum\limits_{i=1}^{M}M_iP_i(\beta) = \frac{1}{Z}\sum\limits_{i=1}^{M}M_i e^{-\beta E_i}
                \end{equation*}
            ...
            Similarly, to have the susceptibility $\chi$, which is its capacity to be attracted or not into a magnetic field, defined by
                ...
                \begin{equation*}
                    \chi = \frac{\langle M^2 \rangle - \langle M \rangle ^2}{kT^2},
                \end{equation*}
            %
            ...
            Using (6), we can write
                ...
                \begin{align*}
                    \chi = \frac{32(e^{8J\beta} + 1)}{ZkT^2} \tag{10}
                \end{align*}
